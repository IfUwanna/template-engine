...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String templateName = hasArgs? args[0] : PropertieUtil.getValue(PROPERTIE_TEMPLATE.getKey());
        String data = hasArgs? args[1] : PropertieUtil.getValue(PROPERTIE_DATA.getKey());
